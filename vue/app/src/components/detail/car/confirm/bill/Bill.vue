<template>
    <div class="bill">
        <div>
            ...
            <div class="without">
                <div class="left">不需要开发票</div>

                <svg t="1526462116775" @click="show = !show" :class="show?'right green':'right'" style=""
                     viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="1505"
