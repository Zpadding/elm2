<template>
  <div class="comment">
    <div>
      ...
      <div class="body">
        <ul>
          <li v-for="(classify, index) in classifys" :class="classify.unsatisfied?index==num?'active unsatisfied':'unsatisfied':index==num?'active':''" @click="num = index">{{classify.name}}({{classify.count}})</li>
        </ul>
      </div>
      <div class="foot">
        <ul>
          <li v-for="(comment, index) in comments">
            ...
            <div class="detail">
              ...
              <p>
                <span>{{comment.rating_star}}个星星</span>
                <span v-if="comment.time_spent_desc">按时到达</span>
              </p>
              <ul>
                <li v-for="(food, count) in comment.item_ratings">
                  <img v-if="food.image_hash" :src="food_url[index][count]" alt="">
                </li>
              </ul>
              <ul>
