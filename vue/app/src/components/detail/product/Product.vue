<template>
    <div class="product" v-if="allFood.length>0">
        <div class="body">
            ...
            <div class="goods">
                <div v-if="allFood" v-for="(food, index) in allFood" :id="'food'+index" :style="animation"
                     @touchstart="scroll" @mousewheel="scroll">
                    ...
                    <ul v-if="food.foods" class="food" v-for="(product, index) in food.foods"
                        @click="foodDetail(product)">
                        <li>
                            ...
                            <div class="detail">
                                <div class="one">
                                    ...
                                    <span class="sign"
                                          v-if="product.attributes.length? product.attributes[0].icon_name=='招牌'? true: product.attributes.length == 2? product.attributes[1].icon_name=='招牌'? true:false :false :false">招牌</span>
                                </div>
                                ...
                                <div class="price">
                                    ...
                                    <div class="right">
                                        <span class="reduce" v-show="product.number"
                                              @click.stop="reduce(product)">-</span>
            ...
            <div class="specfoods" v-if="show">
                <div class="all">
                    ...
                    <div class="middle">
                        <p>规格</p>
                        <div>
                            <span v-for="(specfood, index) in specfoods.specfoods" @click="number = index"
                                  :class="{active: index==number}">{{specfood.specs_name}}</span>
                        </div>
                    </div>
                    <div class="bottom">
                ...
                if (!this.isAni) {
                    ...
                    if (this.shopCar.length > 0) {
                        ...
                        if (isExist) {
                            ...
                            this.shopCar[index].data = product.data;
                            this.shopCar[index].dom = product.dom;
                        } else {
                ...
                if (data.specfoods.length <= 1) {
                    ...
                    for (let i = 0; i < this.shopCar.length; i++) {
                        if (this.shopCar[i].id == food.food_id) {
                            ...
                            this.shopCar[i].data = product.data;
                            this.shopCar[i].dom = product.dom;
