    ...
    <div class="search">
        <div class="mask">
            ...
            <div class="body" v-if="show">
                <h4 v-if="history.length">搜索历史</h4>
                <ul class="history">
                    <li v-for="(his, index) in history" @click="select(his)">
                        <span>{{his}}</span>
                        <span @click.stop="empty(index)">
                ...
                <div v-if="history.length" class="clear" @click="clear">清空搜索历史</div>
            </div>
